...
export const Route = createFileRoute("/_dashboard/o/$orgSlug/p/$projectSlug/task/create")({
          ...
          <DefinitionForm
            ...
            onSubmit={async (values) => {
              try {
                ...
                navigate({ to: "/o/$orgSlug/p/$projectSlug/task/$taskId", params: { orgSlug, projectSlug, taskId: row.id } })
              } catch (err) {
