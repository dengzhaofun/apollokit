 ...
 *   ------------------------------------------
 *   The player logged in via `/api/v1/client/auth/sign-in/email` and we
 ...
 *   `POST /api/v1/users/sync` or hasn't synced at all.
 *
 ...
 * `c.var.clientCredential`. Auth routes themselves (`/api/v1/client/auth/*`)
